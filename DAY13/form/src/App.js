...
validateUsername = () => {
  ...
  // must contain a special character
    ...
    if(password.length < 6 ){
      passwordValid = false;
      errorMsg.password = 'Password must be atleast 6 Characters long';
    }
      ...
      passwordValid = false;
      errorMsg.password = 'Password must contain speacial Character : !@#$%^&*';
    }
    this.setState({passwordValid, errorMsg}, this.validateForm);
  }

  updatePaswordConfirm = (passwordConfirm) => {
      ...
      <div className='App'>
        ...
        <main role='main'>
          ...
          <div className='form-group'>
              ...
              <input type='text' id='email' name='email' className='form-field' value={this.state.email} onChange= {(e) => this.updateEmail(e.target.value)} />
            </div>
            ...
            <div className='form-group'>
              ...
              value={this.state.password} onChange= {(e) => this.updatePasword(e.target.value)} />
            </div>
            ...
            <input type='password' id='password-confirmation' name='password-confirmation' className='form-field' 
              value={this.state.passwordConfirm} onChange= {(e) => this.updatePaswordConfirm(e.target.value)} />
              </div>

              <div className = 'form-controls'>
                <button classsName='button' type='submit' disabled={!this.state.formValid}>Sign Up</button>
              </div>
          </form>
        </main>
      </div>
